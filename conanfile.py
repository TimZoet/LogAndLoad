...
class BetterTestConan(ConanFile):
    ...
    description = "C++ library for low latency logging."
    
    url = "https://github.com/TimZoet/LogAndLoad"
    ...
    def set_version(self):
        ...
        base.set_version(self, "modules/logandload/logandloadVersionString.cmake", "LOGANDLOAD_VERSION")
